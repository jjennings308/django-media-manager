...
class MediaAdmin(admin.ModelAdmin):
    list_display = [
        'id', 'preview', 'get_filename', 'media_type',
        'uploaded_by', 'privacy', 'is_approved', 'is_featured', 'created_at'
    ]
    ...
    readonly_fields = [
        'file_size', 'file_size_mb', 'mime_type', 'file_extension',
    ...
    flag_media.short_description = 'Flag selected media for review'
